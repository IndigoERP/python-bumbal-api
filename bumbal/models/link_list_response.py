...
class LinkListResponse(object):
    ...
    def __init__(self, items=None, count_filtered=None, count_unfiltered=None, count_limited=None, _configuration=None):  # noqa: E501
        """LinkListResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this LinkListResponse.  # noqa: E501

          # noqa: E501

        :return: The items of this LinkListResponse.  # noqa: E501
    ...
    def items(self, items):
        """Sets the items of this LinkListResponse.

          # noqa: E501

        :param items: The items of this LinkListResponse.  # noqa: E501
        :type: list[LinkModel]
        """
    ...
    def count_filtered(self):
        """Gets the count_filtered of this LinkListResponse.  # noqa: E501

        Count of total items with filters in place  # noqa: E501

        :return: The count_filtered of this LinkListResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def count_filtered(self, count_filtered):
        """Sets the count_filtered of this LinkListResponse.

        Count of total items with filters in place  # noqa: E501

        :param count_filtered: The count_filtered of this LinkListResponse.  # noqa: E501
        :type: int
        """
    ...
    def count_unfiltered(self):
        """Gets the count_unfiltered of this LinkListResponse.  # noqa: E501

        Count of total items without filters in place  # noqa: E501

        :return: The count_unfiltered of this LinkListResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def count_unfiltered(self, count_unfiltered):
        """Sets the count_unfiltered of this LinkListResponse.

        Count of total items without filters in place  # noqa: E501

        :param count_unfiltered: The count_unfiltered of this LinkListResponse.  # noqa: E501
        :type: int
        """
    ...
    def count_limited(self):
        """Gets the count_limited of this LinkListResponse.  # noqa: E501

        Count of items with limit in place  # noqa: E501

        :return: The count_limited of this LinkListResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def count_limited(self, count_limited):
        """Sets the count_limited of this LinkListResponse.

        Count of items with limit in place  # noqa: E501

        :param count_limited: The count_limited of this LinkListResponse.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LinkListResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinkListResponse):
            return False
