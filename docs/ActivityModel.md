...
**uuid** | **str** | unique per activity | [optional] 
...
**shipment_activity_nr** | **str** | Number for partner shipment activity | [optional] 
**bundle_shipment_activity_nr** | **str** | Number for partner bundle shipment activity | [optional] 
**nr** | **str** | Number of this Activity | [optional] 
**activity_type_name** | **str** | Activity Type Name. breakdown (:20), bundled (:32), car_end (:6), car_start (:5), car_wash (:27), combi (:29), depot (:28), driver_end (:10), driver_start (:9), dropoff (:2), gas_refill (:14), interior_wash (:30), maintenance (:26), maintenance_planned (:15), maintenance_unplanned (:16), other (:31), pause (:13), pickup (:1), route_end (:4), route_start (:3), sanitary (:21), stop (:11), unplanned_stop (:18), user_other (:17), wait (:19) | [optional] 
...
**status_name** | **str** | Activity Status | [optional] 
**assignment_id** | **int** | Assignment ID | [optional] 
**assignment_nr** | **str** | Assignment NR | [optional] 
**assignment** | [**AssignmentModel**](AssignmentModel.md) |  | [optional] 
**assignment_sequence_nr** | **int** | Assignment sequence number for multi day assignments | [optional] 
**remarks** | **str** | Remarks about this activity | [optional] 
**locked** | **int** | Activity locked status. 0 &#x3D; not locked. 1 &#x3D; locked on route and time. 2 &#x3D; locked on route. | [optional] 
...
**reference** | **str** | Reference of this activity | [optional] 
**description** | **str** | description of this activity | [optional] 
**earliest_delivery_date_time** | **date** |  | [optional] 
**latest_delivery_date_time** | **date** |  | [optional] 
**earliest_delivery_date** | **date** |  | [optional] 
**latest_delivery_date** | **date** |  | [optional] 
**date_time_from** | **datetime** | Earliest date-time | [optional] 
**date_time_to** | **datetime** | latest date-time | [optional] 
**planned_date_time_from** | **datetime** | planned date-time from (only filled for planned activities) | [optional] 
**planned_date_time_to** | **datetime** | planned date-time to (only filled for planned activities) | [optional] 
**executed_date_time_from** | **datetime** | executed date-time from (only filled for executed activities) | [optional] 
**executed_date_time_to** | **datetime** | executed date-time to (only filled for executed activities) | [optional] 
